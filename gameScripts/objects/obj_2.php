...
if (!$approved) {include('../gameScripts/1096.php');exit();}
...
echo '<script>
	...
	orders.innerHTML = "Gather Rsc - condition:'.$thisUnit->get('conditionPoints').'/'.$thisUnit->get('maxCondition').' + '.$thisUnit->get('recoveryRate').'/hr";
