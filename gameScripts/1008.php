...
foreach ($warList->slotData as $warID) {
	...
	echo '<span onclick=scrMod("1126,'.$warID.',1")>Surrender</span>, <span onclick=scrMod("1125,'.$warID.',2")>Offer Peace</span>, <span onclick=scrMod("1126,'.$warID.',3")>Enforce Demands</span>';
	}
}
fclose($warFile);
fclose($unitFile);
